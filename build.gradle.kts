...
weave {
    configure {
        ...
        modId = "healthindicator-modernweave"
        entryPoints = listOf("me.jimin.healthindicator.ExampleMod")
//        hooks = listOf("com.example.mod.hook.MinecraftHook")
        mixinConfigs = listOf("healthindicator.mixins.json")
        accessWideners = listOf("healthindicator.accesswidener.txt")
        mcpMappings()
    }
    version("1.8.9")
}
